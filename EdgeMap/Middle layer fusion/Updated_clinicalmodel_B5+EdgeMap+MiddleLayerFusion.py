...
# Choose fusion layer (CHANGE THIS for experiments)
...
# ==============================
# DUAL BRANCH MODEL WITH MIDDLE FUSION
# ==============================
...
def create_dual_model(img_size):
    ...
    middle_layer = base.get_layer(FUSION_LAYER).output

    x_rgb = layers.GlobalAveragePooling2D()(middle_layer)
    ...
    x_edge = layers.GlobalAveragePooling2D()(x)

    # FEATURE FUSION
    fused = layers.Concatenate()([x_rgb, x_edge])
