...
for fold in range(1, FOLDS + 1):
    ...
    print(f"Fold {fold} class weights: {class_weight_dict}")
    # class_weight_dict looks like {0: <melanoma weight>, 1: <non_melanoma weight>}
    ...
    model.fit(
        ...
        callbacks=[ckpt, reduce_lr, early_stop]  # early_stop added
    )
    ...
    # ==============================
    y_true = val_set_base.classes  # 0 = melanoma, 1 = non_melanoma
...
print("\n================================")
print(f"AVERAGE OVER {FOLDS} FOLDS")
print("================================")
