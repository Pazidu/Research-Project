# =============================================================================
# V36 - EfficientNetV2-S + Channel + Spatial Attention
# =============================================================================
#
...
DRIVE_V36_DIR = "/content/drive/MyDrive/melanoma_checkpoints/V36"
CHECKPOINT_DIR = DRIVE_V36_DIR
MODEL_PATH = os.path.join(DRIVE_V36_DIR, "V36_EfficientNetV2S_ChannelSpatialAttention_StrongerHead_final.keras")
RESULTS_PATH = os.path.join(DRIVE_V36_DIR, "V36_results.json")

# Backup directories for TensorFlow/Keras training-state recovery.
STAGE1_BACKUP_DIR = os.path.join(DRIVE_V36_DIR, "stage1_backup")
STAGE2_BACKUP_DIR = os.path.join(DRIVE_V36_DIR, "stage2_backup")
...
print("\nCONTROLLED CHANGE:")
print("V33 -> V36: Added Spatial Attention after the existing Channel Attention")
...
os.makedirs(DRIVE_V36_DIR, exist_ok=True)
...
# =============================================================================
# CELL 12 - BUILD V36 MODEL
# =============================================================================

print("=" * 80)
print("BUILDING V36 MODEL")
print("=" * 80)
...
# -----------------------------------------------------------------------------
# V36 CONTROLLED CHANGE - STRONGER CLASSIFIER HEAD
# -----------------------------------------------------------------------------
# V35 head:
...
model = Model(
    inputs=inputs,
    outputs=outputs,
    name="V36_EfficientNetV2S_ChannelSpatialAttention_StrongerHead"
)
...
print("=" * 80)
print("V36 STAGE 2 FINE-TUNING PREPARATION")
print("=" * 80)
...
# =============================================================================
# CELL 22 - LOAD BEST V36 MODEL
# =============================================================================

print("=" * 80)
print("LOADING BEST V36 MODEL")
print("=" * 80)
...
print("Best V36 model loaded successfully.")


# =============================================================================
# CELL 23 - SAVE FINAL V36 MODEL
# =============================================================================

print("=" * 80)
print("SAVING V36 MODEL")
print("=" * 80)
...
# =============================================================================
# CELL 29 - V36 VALIDATION RESULTS
# =============================================================================
...
print("=" * 80)
print("V36 VALIDATION CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V36 VALIDATION SENSITIVITY THRESHOLDS")
print("=" * 80)
...
print("=" * 80)
print("V36 FINAL TEST EVALUATION")
print("=" * 80)
...
print("=" * 80)
print("V36 TEST CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V36 TEST CONFUSION MATRIX")
print("=" * 80)
...
print("=" * 80)
print("V36 TEST THRESHOLD COMPARISON")
print("=" * 80)
...
# =============================================================================
# CELL 36 - V36 PROBABILITY ANALYSIS
# =============================================================================
...
print("=" * 80)
print("V36 TEST PROBABILITY ANALYSIS")
print("=" * 80)
...
# =============================================================================
# CELL 41 - SAVE V36 RESULTS
# =============================================================================

print("=" * 80)
print("SAVING V36 RESULTS")
print("=" * 80)
