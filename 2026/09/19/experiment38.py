# =============================================================================
# V38 - EfficientNetV2-S + Channel + Spatial Attention
# =============================================================================
#
...
DRIVE_V38_DIR = "/content/drive/MyDrive/melanoma_checkpoints/V38"
CHECKPOINT_DIR = DRIVE_V38_DIR
MODEL_PATH = os.path.join(DRIVE_V38_DIR, "V38_EfficientNetV2S_ChannelSpatialAttention_StrongerAugmentation_final.keras")
RESULTS_PATH = os.path.join(DRIVE_V38_DIR, "V38_results.json")

# Backup directories for TensorFlow/Keras training-state recovery.
STAGE1_BACKUP_DIR = os.path.join(DRIVE_V38_DIR, "stage1_backup")
STAGE2_BACKUP_DIR = os.path.join(DRIVE_V38_DIR, "stage2_backup")

print("=" * 80)
print("V36 CONFIGURATION")
print("=" * 80)
...
print("\nCONTROLLED CHANGE:")
print("V36 -> V38: Stronger online augmentation only")
...
os.makedirs(DRIVE_V38_DIR, exist_ok=True)
...
train_augmentation = keras.Sequential(
    ...
    name="v38_stronger_augmentation"
)
...
# =============================================================================
#
# V38: NO ARCHITECTURE CHANGE. Only stronger online augmentation.
#
# V33:
...
# =============================================================================
# CELL 12 - BUILD V38 MODEL
# =============================================================================

print("=" * 80)
print("BUILDING V38 MODEL")
print("=" * 80)
...
# -----------------------------------------------------------------------------
# V36 CONTROLLED CHANGE
# -----------------------------------------------------------------------------
#
# V33 already contains Channel Attention.
# V36 adds Spatial Attention immediately after it.
#
# V33:
...
model = Model(
    inputs=inputs,
    outputs=outputs,
    name="V38_EfficientNetV2S_ChannelSpatialAttention_StrongerAugmentation"
)
...
# Recreate the exact V36 focal loss object
loss_function = binary_focal_loss(
    gamma=FOCAL_GAMMA,
    positive_weight=MELANOMA_WEIGHT,
    negative_weight=NON_MELANOMA_WEIGHT
...
print("=" * 80)
print("V38 STAGE 2 FINE-TUNING PREPARATION")
print("=" * 80)
...
# =============================================================================
# CELL 22 - LOAD BEST V38 MODEL
# =============================================================================

print("=" * 80)
print("LOADING BEST V38 MODEL")
print("=" * 80)
...
print("Best V38 model loaded successfully.")


# =============================================================================
# CELL 23 - SAVE FINAL V38 MODEL
# =============================================================================

print("=" * 80)
print("SAVING V38 MODEL")
print("=" * 80)
...
# =============================================================================
# CELL 29 - V38 VALIDATION RESULTS
# =============================================================================
...
print("=" * 80)
print("V38 VALIDATION CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V38 VALIDATION SENSITIVITY THRESHOLDS")
print("=" * 80)
...
print("=" * 80)
print("V38 FINAL TEST EVALUATION")
print("=" * 80)
...
print("=" * 80)
print("V38 TEST CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V38 TEST CONFUSION MATRIX")
print("=" * 80)
...
plt.ylabel("Actual")
plt.title("V36 Test Confusion Matrix")
...
print("=" * 80)
print("V38 TEST THRESHOLD COMPARISON")
print("=" * 80)
...
# =============================================================================
# CELL 36 - V38 PROBABILITY ANALYSIS
# =============================================================================
...
print("=" * 80)
print("V38 TEST PROBABILITY ANALYSIS")
print("=" * 80)
...
plt.title("V36 Test Probability Distribution")
plt.legend()
...
plt.plot(
    fpr,
    tpr,
    label=f"V36 ROC-AUC = {test_roc_auc:.4f}"
)
...
plt.plot(
    recall_curve,
    precision_curve,
    label=f"V36 PR-AUC = {test_pr_auc:.4f}"
)

plt.xlabel("Recall / Sensitivity")
plt.ylabel("Precision")
plt.title("V36 Precision-Recall Curve")
plt.legend()
...
# =============================================================================
# CELL 41 - SAVE V38 RESULTS
# =============================================================================

print("=" * 80)
print("SAVING V38 RESULTS")
print("=" * 80)
...
V36_results = make_json_serializable(
    V36_results
)
...
print(
    "V35 -> V36: Replaced classifier head with a stronger two-layer head"
)
