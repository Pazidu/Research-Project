# =============================================================================
# V37 - EfficientNetV2-S + Channel + Spatial Attention
# =============================================================================
#
...
DRIVE_V37_DIR = "/content/drive/MyDrive/melanoma_checkpoints/V37"
CHECKPOINT_DIR = DRIVE_V37_DIR
MODEL_PATH = os.path.join(DRIVE_V37_DIR, "V37_EfficientNetV2S_ChannelSpatialAttention_StrongerHead_final.keras")
RESULTS_PATH = os.path.join(DRIVE_V37_DIR, "V37_results.json")

# Backup directories for TensorFlow/Keras training-state recovery.
STAGE1_BACKUP_DIR = os.path.join(DRIVE_V37_DIR, "stage1_backup")
STAGE2_BACKUP_DIR = os.path.join(DRIVE_V37_DIR, "stage2_backup")

print("=" * 80)
print("V37 CONFIGURATION")
print("=" * 80)
...
print("\nCONTROLLED CHANGE:")
print("V36 -> V37: Changed focal loss gamma from 1.0 to 2.0")
...
os.makedirs(DRIVE_V37_DIR, exist_ok=True)
...
# =============================================================================
#
# V37 ARCHITECTURE (UNCHANGED FROM V36):
#     EfficientNetV2-S -> Channel Attention -> Spatial Attention -> GAP
#
# The ONLY controlled change in V37 is focal-loss gamma: 1.0 -> 2.0.
#
...
# =============================================================================
# CELL 12 - BUILD V37 MODEL
# =============================================================================

print("=" * 80)
print("BUILDING V37 MODEL")
print("=" * 80)
...
# -----------------------------------------------------------------------------
# V37 ARCHITECTURE (SAME AS V36)
# -----------------------------------------------------------------------------
#
# backbone -> ChannelAttention -> SpatialAttention -> GAP
#
# No architecture change is made in V37.
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# V37 CLASSIFIER HEAD (SAME AS V36)
# -----------------------------------------------------------------------------
#     GAP -> Dense(512) -> Dropout(0.45)
#        -> Dense(128) -> Dropout(0.35) -> Sigmoid
#
# No classifier-head change is made in V37.
# The only change from V36 is focal-loss gamma: 1.0 -> 2.0.
# -----------------------------------------------------------------------------
...
model = Model(
    inputs=inputs,
    outputs=outputs,
    name="V37_EfficientNetV2S_ChannelSpatialAttention_StrongerHead"
)
...
# Recreate the exact V37 focal loss object
loss_function = binary_focal_loss(
    gamma=FOCAL_GAMMA,
    positive_weight=MELANOMA_WEIGHT,
    negative_weight=NON_MELANOMA_WEIGHT
...
print("=" * 80)
print("V37 STAGE 2 FINE-TUNING PREPARATION")
print("=" * 80)
...
# =============================================================================
# CELL 22 - LOAD BEST V37 MODEL
# =============================================================================

print("=" * 80)
print("LOADING BEST V37 MODEL")
print("=" * 80)
...
print("Best V37 model loaded successfully.")


# =============================================================================
# CELL 23 - SAVE FINAL V37 MODEL
# =============================================================================

print("=" * 80)
print("SAVING V37 MODEL")
print("=" * 80)
...
# =============================================================================
# CELL 29 - V37 VALIDATION RESULTS
# =============================================================================
...
print("=" * 80)
print("V37 VALIDATION CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V37 VALIDATION SENSITIVITY THRESHOLDS")
print("=" * 80)
...
print("=" * 80)
print("V37 FINAL TEST EVALUATION")
print("=" * 80)
...
print("=" * 80)
print("V37 TEST CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V37 TEST CONFUSION MATRIX")
print("=" * 80)
...
plt.ylabel("Actual")
plt.title("V37 Test Confusion Matrix")
...
print("=" * 80)
print("V37 TEST THRESHOLD COMPARISON")
print("=" * 80)
...
# =============================================================================
# CELL 36 - V37 PROBABILITY ANALYSIS
# =============================================================================
...
print("=" * 80)
print("V37 TEST PROBABILITY ANALYSIS")
print("=" * 80)
...
plt.title("V37 Test Probability Distribution")
plt.legend()
...
plt.plot(
    fpr,
    tpr,
    label=f"V37 ROC-AUC = {test_roc_auc:.4f}"
)
...
plt.plot(
    recall_curve,
    precision_curve,
    label=f"V37 PR-AUC = {test_pr_auc:.4f}"
)

plt.xlabel("Recall / Sensitivity")
plt.ylabel("Precision")
plt.title("V37 Precision-Recall Curve")
plt.legend()
...
# =============================================================================
# CELL 41 - SAVE V37 RESULTS
# =============================================================================

print("=" * 80)
print("SAVING V37 RESULTS")
print("=" * 80)
...
V37_results = make_json_serializable(
    V37_results
)
...
# =============================================================================
# CELL 42 - FINAL V37 SUMMARY
# =============================================================================

print("\n")
print("=" * 80)
print("V37 FINAL SUMMARY")
print("=" * 80)

print("Controlled change:")
print(
    "V36 -> V37: Changed focal loss gamma from 1.0 to 2.0"
)
