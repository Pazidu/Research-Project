# =============================================================================
# V40 - EfficientNetV2-S + Channel + Spatial Attention
# =============================================================================
#
...
DRIVE_V40_DIR = "/content/drive/MyDrive/melanoma_checkpoints/V40"
CHECKPOINT_DIR = DRIVE_V40_DIR
MODEL_PATH = os.path.join(DRIVE_V40_DIR, "V40_EfficientNetV2S_ChannelSpatialAttention_StrongerHead_final.keras")
RESULTS_PATH = os.path.join(DRIVE_V40_DIR, "V40_results.json")

# Backup directories for TensorFlow/Keras training-state recovery.
STAGE1_BACKUP_DIR = os.path.join(DRIVE_V40_DIR, "stage1_backup")
STAGE2_BACKUP_DIR = os.path.join(DRIVE_V40_DIR, "stage2_backup")

print("=" * 80)
print("V40 CONFIGURATION")
print("=" * 80)
...
print("\nCONTROLLED CHANGE:")
print("V33 -> V40: Added Spatial Attention after the existing Channel Attention")
...
os.makedirs(DRIVE_V40_DIR, exist_ok=True)
...
# =============================================================================
# CELL 12 - BUILD V40 MODEL
# =============================================================================

print("=" * 80)
print("BUILDING V40 MODEL")
print("=" * 80)
...
# V40 adds Spatial Attention immediately after it.
#
# V33:
...
# -----------------------------------------------------------------------------
# V40 CONTROLLED CHANGE - STRONGER CLASSIFIER HEAD
# -----------------------------------------------------------------------------
# V35 head:
#     GAP -> Dropout(0.45) -> Dense(256) -> Dropout(0.35) -> Sigmoid
#
# V40 head:
#     GAP -> Dense(512) -> Dropout(0.45)
#        -> Dense(128) -> Dropout(0.35) -> Sigmoid
#
# ONLY the classifier head is changed from V35.
# Backbone, channel attention, spatial attention, loss, augmentation,
# image size, batch size, learning rates, and fine-tuning settings remain the same.
# -----------------------------------------------------------------------------
...
model = Model(
    inputs=inputs,
    outputs=outputs,
    name="V40_EfficientNetV2S_ChannelSpatialAttention_StrongerHead"
)
...
# Recreate the exact V40 focal loss object
loss_function = binary_focal_loss(
    gamma=FOCAL_GAMMA,
    positive_weight=MELANOMA_WEIGHT,
    negative_weight=NON_MELANOMA_WEIGHT
...
print("=" * 80)
print("V40 STAGE 2 FINE-TUNING PREPARATION")
print("=" * 80)
...
# =============================================================================
# CELL 22 - LOAD BEST V40 MODEL
# =============================================================================

print("=" * 80)
print("LOADING BEST V40 MODEL")
print("=" * 80)
...
print("Best V40 model loaded successfully.")


# =============================================================================
# CELL 23 - SAVE FINAL V40 MODEL
# =============================================================================

print("=" * 80)
print("SAVING V40 MODEL")
print("=" * 80)
...
# =============================================================================
# CELL 29 - V40 VALIDATION RESULTS
# =============================================================================
...
print("=" * 80)
print("V40 VALIDATION CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V40 VALIDATION SENSITIVITY THRESHOLDS")
print("=" * 80)
...
print("=" * 80)
print("V40 FINAL TEST EVALUATION")
print("=" * 80)
...
print("=" * 80)
print("V40 TEST CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V40 TEST CONFUSION MATRIX")
print("=" * 80)
...
plt.ylabel("Actual")
plt.title("V40 Test Confusion Matrix")
...
print("=" * 80)
print("V40 TEST THRESHOLD COMPARISON")
print("=" * 80)
...
# =============================================================================
# CELL 36 - V40 PROBABILITY ANALYSIS
# =============================================================================
...
print("=" * 80)
print("V40 TEST PROBABILITY ANALYSIS")
print("=" * 80)
...
plt.title("V40 Test Probability Distribution")
plt.legend()
...
plt.plot(
    fpr,
    tpr,
    label=f"V40 ROC-AUC = {test_roc_auc:.4f}"
)
...
plt.plot(
    recall_curve,
    precision_curve,
    label=f"V40 PR-AUC = {test_pr_auc:.4f}"
)

plt.xlabel("Recall / Sensitivity")
plt.ylabel("Precision")
plt.title("V40 Precision-Recall Curve")
plt.legend()
...
# =============================================================================
# CELL 41 - SAVE V40 RESULTS
# =============================================================================

print("=" * 80)
print("SAVING V40 RESULTS")
print("=" * 80)
...
V40_results = make_json_serializable(
    V40_results
)
...
# =============================================================================
# CELL 42 - FINAL V40 SUMMARY
# =============================================================================

print("\n")
print("=" * 80)
print("V40 FINAL SUMMARY")
print("=" * 80)

print("Controlled change:")
print(
    "V35 -> V40: Replaced classifier head with a stronger two-layer head"
)
