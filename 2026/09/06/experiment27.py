...
print("=" * 70)
print("V27 MELANOMA CLASSIFICATION")
print("=" * 70)
...
# ================================================================
# CELL 5 - V27 DATASET CONFIGURATION
# ================================================================

print("\n" + "=" * 70)
print("V27 DATASET CONFIGURATION")
print("=" * 70)
...
DATASET = "/content/newdata_offline_aug"
...
# V27 controlled experiment:
# Offline augmentation of the melanoma training class.
#
# V25 pipeline is preserved:
# - 300x300 resolution
# - EfficientNetV2-S
# - same online augmentation
# - same weighted focal loss
# - same optimizer and learning rates
# - same 40% fine-tuning
# - same threshold selection policy
#
# The controlled change is the offline-augmented training dataset.
...
# V27 focal-loss focusing parameter
FOCAL_GAMMA = 1.0
...
# ================================================================
# CELL 7 - VERIFY V27 OFFLINE-AUGMENTED DATASET
# ================================================================

print("\n" + "=" * 70)
print("VERIFYING V27 OFFLINE-AUGMENTED DATASET")
print("=" * 70)
...
if not os.path.exists(DATASET):
    ...
    raise FileNotFoundError(
        "V27 offline-augmented dataset was not found:\n\n"
        f"{DATASET}\n\n"
        "Run the offline augmentation script first."
    )
...
if not has_required_dataset_structure(DATASET):
    ...
    raise FileNotFoundError(
        "V27 dataset exists, but the required "
        "directory structure was not found.\n\n"
        f"Dataset: {DATASET}\n\n"
        "Expected structure:\n"
        "newdata_offline_aug/\n"
...
print("\nV27 offline-augmented dataset verified.")
print(DATASET)
...
# ================================================================
# CELL 14 - V27  DATA AUGMENTATION
# ================================================================

print("\n" + "=" * 70)
print("CREATING V27 DATA AUGMENTATION")
print("=" * 70)
...
data_augmentation = tf.keras.Sequential(
    ...
    [
        ...
        # ------------------------------------------------
        # V27 controlled augmentation (unchanged from V20)
        # ------------------------------------------------
    ...
    name="v27_augmentation"
)


print(
    "V27 augmentation created."
)
...
# ================================================================
# CELL 15 - V27 WEIGHTED FOCAL LOSS
# ================================================================
...
class MelanomaWeightedFocalLoss(
    ...
    def call(
        ...
        # difficult examples. gamma=1 is the controlled V27 focal-loss
...
# ================================================================
# CELL 17 - CREATE V27 MODEL
# ================================================================

print("\n" + "=" * 70)
print("CREATING V27 MODEL")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V27 STAGE 1 - FROZEN EFFICIENTNETV2-S")
print("=" * 70)
...
print("\n" + "=" * 70)
print("LOADING BEST V27 STAGE 1 MODEL")
print("=" * 70)
...
print("\n" + "=" * 70)
print("PREPARING V27 FINE-TUNING")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V27 STAGE 2 - FINE-TUNING EFFICIENTNETV2-S")
print("=" * 70)
...
# ================================================================
# CELL 27 - LOAD ABSOLUTE BEST V27 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("LOADING ABSOLUTE BEST V27 MODEL")
print("=" * 70)
...
print(
    "Absolute best V27 model loaded."
)
...
# ================================================================
# CELL 29 - V27 VALIDATION PREDICTIONS
# ================================================================
...
# ================================================================
# CELL 30 - V27 VALIDATION PERFORMANCE
# ================================================================
...
# ================================================================
# CELL 32 - V27 VALIDATION THRESHOLD SEARCH
# ================================================================
...
# ================================================================
# CELL 33 - V27 SENSITIVITY-CONSTRAINED SEARCH
# ================================================================
...
# ================================================================
# CELL 34 - SELECT FINAL V27 THRESHOLD
# ================================================================
...
# ================================================================
# CELL 37 - FINAL V27 TEST RESULTS
# ================================================================
...
# ================================================================
# CELL 39 - V27 CLASSIFICATION REPORT
# ================================================================
...
# ================================================================
# CELL 40 - V27 TEST THRESHOLD COMPARISON
# ================================================================
...
# ================================================================
# CELL 41 - V27 PROBABILITY ANALYSIS
# ================================================================
...
# ================================================================
# CELL 43 - V27 PRECISION RECALL CURVE
# ================================================================
...
# ================================================================
# CELL 44 - V27 CONFUSION MATRIX PLOT
# ================================================================
...
# ================================================================
# CELL 52 - V27 EXPERIMENT SUMMARY
# ================================================================
...
# ================================================================
# CELL 55 - PERFORMANCE COMPARISON
# V14 -> V27
# ================================================================

print("\n")
print("=" * 80)
print("PERFORMANCE COMPARISON - V14 TO V27")
print("=" * 80)
...
print("\n")
print("=" * 80)
print("V27 IMPROVEMENT / CHANGE FROM V25")
print("=" * 80)

print(
    v27_vs_v25.to_string(
        float_format=lambda x: f"{x:+.4f}"
    )
)
...
print("\n")
print("=" * 80)
print("V27 IMPROVEMENT / CHANGE FROM V26")
print("=" * 80)

print(
    v27_vs_v26.to_string(
        float_format=lambda x: f"{x:+.4f}"
    )
)
...
print("\n")
print("=" * 70)
print("V27 FINISHED SUCCESSFULLY")
print("=" * 70)
