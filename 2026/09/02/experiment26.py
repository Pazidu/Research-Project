...
print("=" * 70)
print("V26 MELANOMA CLASSIFICATION")
print("=" * 70)
...
# ================================================================
# CELL 5 - V26 DATASET CONFIGURATION
# ================================================================

print("\n" + "=" * 70)
print("V26 DATASET CONFIGURATION")
print("=" * 70)
...
# V26 controlled experiment: input resolution only.
# V25 input resolution: 300 -> 384.
# All other V25 data, augmentation, loss, optimizer, classifier, fine-tuning,
# threshold, and evaluation settings are preserved.
...
# V26 focal-loss focusing parameter
FOCAL_GAMMA = 1.0
...
# ================================================================
# CELL 14 - V26 DATA AUGMENTATION
# ================================================================

print("\n" + "=" * 70)
print("CREATING V26 DATA AUGMENTATION")
print("=" * 70)
...
data_augmentation = tf.keras.Sequential(
    ...
    [
        ...
        # ------------------------------------------------
        # V26 augmentation (unchanged from V25)
        # ------------------------------------------------
    ...
    name="v26_augmentation"
)


print(
    "V26 augmentation created."
)
...
# ================================================================
# CELL 15 - V26 WEIGHTED FOCAL LOSS
# ================================================================
...
class MelanomaWeightedFocalLoss(
    ...
    def call(
        ...
        # difficult examples. gamma=1 is the controlled V26 focal-loss
...
# ================================================================
# CELL 17 - CREATE V26 MODEL
# ================================================================

print("\n" + "=" * 70)
print("CREATING V26 MODEL")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V26 STAGE 1 - FROZEN EFFICIENTNETV2-S")
print("=" * 70)
...
print("\n" + "=" * 70)
print("LOADING BEST V26 STAGE 1 MODEL")
print("=" * 70)
...
print("\n" + "=" * 70)
print("PREPARING V26 FINE-TUNING")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V26 STAGE 2 - FINE-TUNING EFFICIENTNETV2-S")
print("=" * 70)
...
# ================================================================
# CELL 27 - LOAD ABSOLUTE BEST V26 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("LOADING ABSOLUTE BEST V26 MODEL")
print("=" * 70)
...
print(
    "Absolute best V26 model loaded."
)
...
# ================================================================
# CELL 29 - V26 VALIDATION PREDICTIONS
# ================================================================

print("\n")
print("=" * 70)
print("V26 VALIDATION PREDICTIONS")
print("=" * 70)
...
# ================================================================
# CELL 30 - V26 VALIDATION PERFORMANCE
# ================================================================

print("\n" + "=" * 70)
print("V26 VALIDATION PERFORMANCE")
print("=" * 70)
...
# ================================================================
# CELL 32 - V26 VALIDATION THRESHOLD SEARCH
# ================================================================

print("\n")
print("=" * 70)
print("V26 VALIDATION THRESHOLD SEARCH")
print("=" * 70)
...
# ================================================================
# CELL 33 - V26 SENSITIVITY-CONSTRAINED SEARCH
# ================================================================

print("\n")
print("=" * 70)
print("V26 SENSITIVITY-CONSTRAINED THRESHOLD SEARCH")
print("=" * 70)
...
# ================================================================
# CELL 34 - SELECT FINAL V26 THRESHOLD
# ================================================================

print("\n")
print("=" * 70)
print("SELECTING V26 FINAL THRESHOLD")
print("=" * 70)
...
# ================================================================
# CELL 35 - V26 TEST PREDICTIONS
# ================================================================

print("\n")
print("=" * 70)
print("V26 TEST PREDICTIONS")
print("=" * 70)
...
# ================================================================
# CELL 36 - V26 TEST ROC / PR
# ================================================================

print("\n")
print("=" * 70)
print("V26 TEST ROC / PR")
print("=" * 70)
...
# ================================================================
# CELL 37 - FINAL V26 TEST RESULTS
# ================================================================
...
# ================================================================
# CELL 39 - V26 CLASSIFICATION REPORT
# ================================================================

print("\n")
print("=" * 70)
print("V26 CLASSIFICATION REPORT")
print("=" * 70)
...
# ================================================================
# CELL 40 - V26 TEST THRESHOLD COMPARISON
# ================================================================

print("\n")
print("=" * 70)
print("V26 TEST THRESHOLD COMPARISON")
print("=" * 70)
...
# ================================================================
# CELL 41 - V26 PROBABILITY ANALYSIS
# ================================================================

print("\n")
print("=" * 70)
print("V26 PROBABILITY ANALYSIS")
print("=" * 70)
...
plt.plot(
    ...
    label=f"V26 ROC-AUC = {test_roc_auc:.4f}"
...
# ================================================================
# CELL 43 - V26 PRECISION RECALL CURVE
# ================================================================
...
plt.plot(
    ...
    label=f"V26 PR-AUC = {test_pr_auc:.4f}"
...
# ================================================================
# CELL 44 - V26 CONFUSION MATRIX PLOT
# ================================================================
...
# ================================================================
# CELL 52 - V26 EXPERIMENT SUMMARY
# ================================================================
...
# ================================================================
# CELL 54 - SAVE FINAL V26 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("SAVING FINAL V26 MODEL")
print("=" * 70)
...
# ================================================================
# ================================================================
# CELL 55 - V14 VS V16 VS V17 VS V18 VS V26
# ================================================================

print("\n")
print("=" * 70)
print("V14 VS V16 VS V17 VS V18 VS V26")
print("=" * 70)
...
# ------------------------------------------------
# V25 results from the completed V25 experiment
# ------------------------------------------------
v25_metrics = {
    "ROC-AUC": 0.8910,
    "PR-AUC": 0.5526,
...
# ------------------------------------------------
# V26 results from the current experiment
# ------------------------------------------------
v26_metrics = {
...
comparison_df["V26 - V25"] = comparison_df["V26"] - comparison_df["V25"]
comparison_df["V26 - V20"] = comparison_df["V26"] - comparison_df["V20"]
comparison_df["V26 - V19"] = comparison_df["V26"] - comparison_df["V19"]
comparison_df["V26 - V18"] = comparison_df["V26"] - comparison_df["V18"]
comparison_df["V26 - V17"] = comparison_df["V26"] - comparison_df["V17"]
comparison_df["V26 - V16"] = comparison_df["V26"] - comparison_df["V16"]
comparison_df["V26 - V14"] = comparison_df["V26"] - comparison_df["V14"]
print(
...
# CELL 56 - FINAL V26 SUMMARY
# ================================================================

print("\n")
print("=" * 70)
print("V26 EXPERIMENT COMPLETE")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V26 FINISHED SUCCESSFULLY")
print("=" * 70)
