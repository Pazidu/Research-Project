# =============================================================================
# V39 - EfficientNetV2-S + Channel + Spatial Attention
# =============================================================================
#
...
DRIVE_V39_DIR = "/content/drive/MyDrive/melanoma_checkpoints/V39"
CHECKPOINT_DIR = DRIVE_V39_DIR
MODEL_PATH = os.path.join(DRIVE_V39_DIR, "V39_EfficientNetV2S_ChannelSpatialAttention_StrongerHead_final.keras")
RESULTS_PATH = os.path.join(DRIVE_V39_DIR, "V39_results.json")

# Backup directories for TensorFlow/Keras training-state recovery.
STAGE1_BACKUP_DIR = os.path.join(DRIVE_V39_DIR, "stage1_backup")
STAGE2_BACKUP_DIR = os.path.join(DRIVE_V39_DIR, "stage2_backup")

print("=" * 80)
print("V39 CONFIGURATION")
print("=" * 80)
...
print("\nCONTROLLED CHANGE:")
print("V36 -> V39: Increased MELANOMA_WEIGHT from 1.5 to 2.0")
...
os.makedirs(DRIVE_V39_DIR, exist_ok=True)
...
# =============================================================================
# CELL 12 - BUILD V39 MODEL
# =============================================================================

print("=" * 80)
print("BUILDING V39 MODEL")
print("=" * 80)
...
# V39 adds Spatial Attention immediately after it.
#
# V33:
...
# -----------------------------------------------------------------------------
# V39 CONTROLLED CHANGE - STRONGER CLASSIFIER HEAD
# -----------------------------------------------------------------------------
# V35 head:
...
model = Model(
    inputs=inputs,
    outputs=outputs,
    name="V39_EfficientNetV2S_ChannelSpatialAttention_StrongerHead"
)
...
# Recreate the exact V39 focal loss object
loss_function = binary_focal_loss(
    gamma=FOCAL_GAMMA,
    positive_weight=MELANOMA_WEIGHT,
    negative_weight=NON_MELANOMA_WEIGHT
...
print("=" * 80)
print("V39 STAGE 2 FINE-TUNING PREPARATION")
print("=" * 80)
...
# =============================================================================
# CELL 22 - LOAD BEST V39 MODEL
# =============================================================================

print("=" * 80)
print("LOADING BEST V39 MODEL")
print("=" * 80)
...
print("Best V39 model loaded successfully.")


# =============================================================================
# CELL 23 - SAVE FINAL V39 MODEL
# =============================================================================

print("=" * 80)
print("SAVING V39 MODEL")
print("=" * 80)
...
# =============================================================================
# CELL 29 - V39 VALIDATION RESULTS
# =============================================================================
...
print("=" * 80)
print("V39 VALIDATION CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V39 VALIDATION SENSITIVITY THRESHOLDS")
print("=" * 80)
...
print("=" * 80)
print("V39 FINAL TEST EVALUATION")
print("=" * 80)
...
print("=" * 80)
print("V39 TEST CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V39 TEST CONFUSION MATRIX")
print("=" * 80)
...
plt.ylabel("Actual")
plt.title("V39 Test Confusion Matrix")
...
print("=" * 80)
print("V39 TEST THRESHOLD COMPARISON")
print("=" * 80)
...
# =============================================================================
# CELL 36 - V39 PROBABILITY ANALYSIS
# =============================================================================
...
print("=" * 80)
print("V39 TEST PROBABILITY ANALYSIS")
print("=" * 80)
...
plt.title("V39 Test Probability Distribution")
plt.legend()
...
plt.plot(
    fpr,
    tpr,
    label=f"V39 ROC-AUC = {test_roc_auc:.4f}"
)
...
plt.plot(
    recall_curve,
    precision_curve,
    label=f"V39 PR-AUC = {test_pr_auc:.4f}"
)

plt.xlabel("Recall / Sensitivity")
plt.ylabel("Precision")
plt.title("V39 Precision-Recall Curve")
plt.legend()
...
# =============================================================================
# CELL 41 - SAVE V39 RESULTS
# =============================================================================

print("=" * 80)
print("SAVING V39 RESULTS")
print("=" * 80)
...
V39_results = {
    ...
    "controlled_change": {
        "description":
            "Increased MELANOMA_WEIGHT from 1.5 to 2.0",
...
V39_results = make_json_serializable(
    V39_results
)
...
# =============================================================================
# CELL 42 - FINAL V39 SUMMARY
# =============================================================================

print("\n")
print("=" * 80)
print("V39 FINAL SUMMARY")
print("=" * 80)

print("Controlled change:")
print(
    "V36 -> V39: Increased MELANOMA_WEIGHT from 1.5 to 2.0"
)
