...
CHECKPOINT_DIR = "/content/V34_checkpoints"
MODEL_PATH = "/content/V34_EfficientNetV2S_ChannelAttention_final.keras"
RESULTS_PATH = "/content/V34_results.json"

os.makedirs(CHECKPOINT_DIR, exist_ok=True)

print("=" * 80)
print("V34 CONFIGURATION")
print("=" * 80)
...
print("\nCONTROLLED CHANGE:")
print("V33 -> V34: Stage 2 learning rate changed from 1e-5 to 5e-6")
...
# =============================================================================
# CELL 12 - BUILD V34 MODEL
# =============================================================================

print("=" * 80)
print("BUILDING V34 MODEL")
print("=" * 80)
...
model = Model(
    inputs=inputs,
    outputs=outputs,
    name="V34_EfficientNetV2S_ChannelAttention"
)
...
# Recreate the exact V34 focal loss object
loss_function = binary_focal_loss(
    gamma=FOCAL_GAMMA,
    positive_weight=MELANOMA_WEIGHT,
    negative_weight=NON_MELANOMA_WEIGHT
...
print("=" * 80)
print("V34 STAGE 2 FINE-TUNING PREPARATION")
print("=" * 80)
...
# =============================================================================
# CELL 22 - LOAD BEST V34 MODEL
# =============================================================================

print("=" * 80)
print("LOADING BEST V34 MODEL")
print("=" * 80)
...
print("Best V34 model loaded successfully.")


# =============================================================================
# CELL 23 - SAVE FINAL V34 MODEL
# =============================================================================

print("=" * 80)
print("SAVING V34 MODEL")
print("=" * 80)
...
# =============================================================================
# CELL 29 - V34 VALIDATION RESULTS
# =============================================================================
...
print("=" * 80)
print("V34 VALIDATION CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V34 VALIDATION SENSITIVITY THRESHOLDS")
print("=" * 80)
...
print("=" * 80)
print("V34 FINAL TEST EVALUATION")
print("=" * 80)
...
print("=" * 80)
print("V34 TEST CLASSIFICATION REPORT")
print("=" * 80)
...
print("=" * 80)
print("V34 TEST CONFUSION MATRIX")
print("=" * 80)
...
plt.ylabel("Actual")
plt.title("V34 Test Confusion Matrix")
...
print("=" * 80)
print("V34 TEST THRESHOLD COMPARISON")
print("=" * 80)
...
# =============================================================================
# CELL 36 - V34 PROBABILITY ANALYSIS
# =============================================================================
...
print("=" * 80)
print("V34 TEST PROBABILITY ANALYSIS")
print("=" * 80)
...
plt.title("V34 Test Probability Distribution")
plt.legend()
...
plt.plot(
    fpr,
    tpr,
    label=f"V34 ROC-AUC = {test_roc_auc:.4f}"
)
...
plt.plot(
    recall_curve,
    precision_curve,
    label=f"V34 PR-AUC = {test_pr_auc:.4f}"
)

plt.xlabel("Recall / Sensitivity")
plt.ylabel("Precision")
plt.title("V34 Precision-Recall Curve")
plt.legend()
...
# =============================================================================
# CELL 41 - SAVE V34 RESULTS
# =============================================================================

print("=" * 80)
print("SAVING V34 RESULTS")
print("=" * 80)
...
V34_results = {
    ...
    "controlled_change": {
        ...
        "baseline": "V33",
        "V33_stage2_learning_rate": 1e-5,
        "V34_stage2_learning_rate": 5e-6,
...
V34_results = make_json_serializable(
    V34_results
)
...
# =============================================================================
# CELL 42 - FINAL V34 SUMMARY
# =============================================================================

print("\n")
print("=" * 80)
print("V34 FINAL SUMMARY")
print("=" * 80)

print("Controlled change:")
print(
    "V33 -> V34: Changed Stage 2 learning rate from 1e-5 to 5e-6"
)
