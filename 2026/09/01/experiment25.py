...
print("=" * 70)
print("V25 MELANOMA CLASSIFICATION")
print("=" * 70)
...
# ================================================================
# CELL 5 - V25 DATASET CONFIGURATION
# ================================================================

print("\n" + "=" * 70)
print("V25 DATASET CONFIGURATION")
print("=" * 70)
...
# V25 controlled experiment: classifier regularization only.
# V21 baseline dropout: 0.35 -> 0.45 (after GAP), 0.25 -> 0.35 (after Dense).
# All other V21 data, resolution, augmentation, loss, optimizer, fine-tuning,
...
# V25 focal-loss focusing parameter
FOCAL_GAMMA = 1.0
...
# ================================================================
# CELL 14 - V25 DATA AUGMENTATION
# ================================================================

print("\n" + "=" * 70)
print("CREATING V25 DATA AUGMENTATION")
print("=" * 70)
...
data_augmentation = tf.keras.Sequential(
    ...
    [
        ...
        # ------------------------------------------------
        # V25 controlled augmentation (unchanged from V20)
        # ------------------------------------------------
    ...
    name="v25_augmentation"
)


print(
    "V25 augmentation created."
)
...
# ================================================================
# CELL 15 - V25 WEIGHTED FOCAL LOSS
# ================================================================
...
class MelanomaWeightedFocalLoss(
    ...
    def call(
        ...
        # difficult examples. gamma=1 is the controlled V25 focal-loss
...
# ================================================================
# CELL 17 - CREATE V25 MODEL
# ================================================================

print("\n" + "=" * 70)
print("CREATING V25 MODEL")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V25 STAGE 1 - FROZEN EFFICIENTNETV2-S")
print("=" * 70)
...
print("\n" + "=" * 70)
print("LOADING BEST V25 STAGE 1 MODEL")
print("=" * 70)
...
print("\n" + "=" * 70)
print("PREPARING V25 FINE-TUNING")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V25 STAGE 2 - FINE-TUNING EFFICIENTNETV2-S")
print("=" * 70)
...
# ================================================================
# CELL 27 - LOAD ABSOLUTE BEST V25 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("LOADING ABSOLUTE BEST V25 MODEL")
print("=" * 70)
...
print(
    "Absolute best V25 model loaded."
)
...
# ================================================================
# CELL 29 - V25 VALIDATION PREDICTIONS
# ================================================================

print("\n")
print("=" * 70)
print("V25 VALIDATION PREDICTIONS")
print("=" * 70)
...
# ================================================================
# CELL 30 - V25 VALIDATION PERFORMANCE
# ================================================================

print("\n" + "=" * 70)
print("V25 VALIDATION PERFORMANCE")
print("=" * 70)
...
# ================================================================
# CELL 32 - V25 VALIDATION THRESHOLD SEARCH
# ================================================================

print("\n")
print("=" * 70)
print("V25 VALIDATION THRESHOLD SEARCH")
print("=" * 70)
...
# ================================================================
# CELL 33 - V25 SENSITIVITY-CONSTRAINED SEARCH
# ================================================================

print("\n")
print("=" * 70)
print("V25 SENSITIVITY-CONSTRAINED THRESHOLD SEARCH")
print("=" * 70)
...
# ================================================================
# CELL 34 - SELECT FINAL V25 THRESHOLD
# ================================================================

print("\n")
print("=" * 70)
print("SELECTING V25 FINAL THRESHOLD")
print("=" * 70)
...
# ================================================================
# CELL 35 - V25 TEST PREDICTIONS
# ================================================================

print("\n")
print("=" * 70)
print("V25 TEST PREDICTIONS")
print("=" * 70)
...
# ================================================================
# CELL 36 - V25 TEST ROC / PR
# ================================================================

print("\n")
print("=" * 70)
print("V25 TEST ROC / PR")
print("=" * 70)
...
# ================================================================
# CELL 37 - FINAL V25 TEST RESULTS
# ================================================================
...
# ================================================================
# CELL 39 - V25 CLASSIFICATION REPORT
# ================================================================

print("\n")
print("=" * 70)
print("V25 CLASSIFICATION REPORT")
print("=" * 70)
...
# ================================================================
# CELL 40 - V25 TEST THRESHOLD COMPARISON
# ================================================================

print("\n")
print("=" * 70)
print("V25 TEST THRESHOLD COMPARISON")
print("=" * 70)
...
# ================================================================
# CELL 41 - V25 PROBABILITY ANALYSIS
# ================================================================

print("\n")
print("=" * 70)
print("V25 PROBABILITY ANALYSIS")
print("=" * 70)
...
plt.plot(
    ...
    label=f"V25 ROC-AUC = {test_roc_auc:.4f}"
...
# ================================================================
# CELL 43 - V25 PRECISION RECALL CURVE
# ================================================================
...
plt.plot(
    ...
    label=f"V25 PR-AUC = {test_pr_auc:.4f}"
...
# ================================================================
# CELL 44 - V25 CONFUSION MATRIX PLOT
# ================================================================
...
# ================================================================
# CELL 52 - V25 EXPERIMENT SUMMARY
# ================================================================
...
# ================================================================
# CELL 54 - SAVE FINAL V25 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("SAVING FINAL V25 MODEL")
print("=" * 70)
...
# ================================================================
# ================================================================
# CELL 55 - V14 VS V16 VS V17 VS V18 VS V25
# ================================================================

print("\n")
print("=" * 70)
print("V14 VS V16 VS V17 VS V18 VS V25")
print("=" * 70)
...
# ------------------------------------------------
# V25 results from the current experiment
# ------------------------------------------------
v25_metrics = {
...
comparison_df["V25 - V20"] = comparison_df["V25"] - comparison_df["V20"]
comparison_df["V25 - V19"] = comparison_df["V25"] - comparison_df["V19"]
comparison_df["V25 - V18"] = comparison_df["V25"] - comparison_df["V18"]
comparison_df["V25 - V17"] = comparison_df["V25"] - comparison_df["V17"]
comparison_df["V25 - V16"] = comparison_df["V25"] - comparison_df["V16"]
comparison_df["V25 - V14"] = comparison_df["V25"] - comparison_df["V14"]
print(
...
# CELL 56 - FINAL V25 SUMMARY
# ================================================================

print("\n")
print("=" * 70)
print("V25 EXPERIMENT COMPLETE")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V25 FINISHED SUCCESSFULLY")
print("=" * 70)
