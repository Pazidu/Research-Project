...
MODEL_SAVE_PATH = (
    ...
    "dermoscopy/efficientnetv2s_dual_branch_exp1.keras"
)
...
# 🔥 ONLY CHANGE HERE (EXPERIMENT 1)
FUSION_LAYER = "block5i_add"

# =========================================================
# LIGHT AUGMENTATION (keep SAME as baseline)
# =========================================================
...
def create_dual_model():
    ...
    # SIMPLE ATTENTION (same as baseline)
...
checkpoint_best = ModelCheckpoint(
    filepath=f"{CHECKPOINT_DIR}/best_dual_{FUSION_LAYER}_exp1.keras",
