...
print("=" * 70)
print("V19 MELANOMA CLASSIFICATION")
print("=" * 70)
...
# ================================================================
# CELL 5 - V19 DATASET CONFIGURATION
# ================================================================

print("\n" + "=" * 70)
print("V19 DATASET CONFIGURATION")
print("=" * 70)
...
# V19 focal-loss focusing parameter
FOCAL_GAMMA = 1.0
...
# ================================================================
# CELL 14 - V19 DATA AUGMENTATION
# ================================================================

print("\n" + "=" * 70)
print("CREATING V19 DATA AUGMENTATION")
print("=" * 70)
...
data_augmentation = tf.keras.Sequential(
    ...
    name="v19_augmentation"
)


print(
    "V19 augmentation created."
)
...
# ================================================================
# CELL 15 - V19 WEIGHTED FOCAL LOSS
# ================================================================
...
class MelanomaWeightedFocalLoss(
    ...
    def call(
        ...
        # difficult examples. gamma=1 is the controlled V19 focal-loss
...
# ================================================================
# CELL 17 - CREATE V19 MODEL
# ================================================================

print("\n" + "=" * 70)
print("CREATING V19 MODEL")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V19 STAGE 1 - FROZEN EFFICIENTNETV2-S")
print("=" * 70)
...
print("\n" + "=" * 70)
print("LOADING BEST V19 STAGE 1 MODEL")
print("=" * 70)
...
print("\n" + "=" * 70)
print("PREPARING V19 FINE-TUNING")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V19 STAGE 2 - FINE-TUNING EFFICIENTNETV2-S")
print("=" * 70)
...
# ================================================================
# CELL 27 - LOAD ABSOLUTE BEST V19 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("LOADING ABSOLUTE BEST V19 MODEL")
print("=" * 70)
...
print(
    "Absolute best V19 model loaded."
)
...
# ================================================================
# CELL 29 - V19 VALIDATION PREDICTIONS
# ================================================================

print("\n")
print("=" * 70)
print("V19 VALIDATION PREDICTIONS")
print("=" * 70)
...
# ================================================================
# CELL 30 - V19 VALIDATION PERFORMANCE
# ================================================================

print("\n" + "=" * 70)
print("V19 VALIDATION PERFORMANCE")
print("=" * 70)
...
# ================================================================
# CELL 32 - V19 VALIDATION THRESHOLD SEARCH
# ================================================================

print("\n")
print("=" * 70)
print("V19 VALIDATION THRESHOLD SEARCH")
print("=" * 70)
...
# ================================================================
# CELL 33 - V19 SENSITIVITY-CONSTRAINED SEARCH
# ================================================================

print("\n")
print("=" * 70)
print("V19 SENSITIVITY-CONSTRAINED THRESHOLD SEARCH")
print("=" * 70)
...
# ================================================================
# CELL 34 - SELECT FINAL V19 THRESHOLD
# ================================================================

print("\n")
print("=" * 70)
print("SELECTING V19 FINAL THRESHOLD")
print("=" * 70)
...
# ================================================================
# CELL 35 - V19 TEST PREDICTIONS
# ================================================================

print("\n")
print("=" * 70)
print("V19 TEST PREDICTIONS")
print("=" * 70)
...
# ================================================================
# CELL 36 - V19 TEST ROC / PR
# ================================================================

print("\n")
print("=" * 70)
print("V19 TEST ROC / PR")
print("=" * 70)
...
# ================================================================
# CELL 37 - FINAL V19 TEST RESULTS
# ================================================================
...
# ================================================================
# CELL 39 - V19 CLASSIFICATION REPORT
# ================================================================

print("\n")
print("=" * 70)
print("V19 CLASSIFICATION REPORT")
print("=" * 70)
...
# ================================================================
# CELL 40 - V19 TEST THRESHOLD COMPARISON
# ================================================================

print("\n")
print("=" * 70)
print("V19 TEST THRESHOLD COMPARISON")
print("=" * 70)
...
# ================================================================
# CELL 41 - V19 PROBABILITY ANALYSIS
# ================================================================

print("\n")
print("=" * 70)
print("V19 PROBABILITY ANALYSIS")
print("=" * 70)
...
plt.plot(
    ...
    label=f"V19 ROC-AUC = {test_roc_auc:.4f}"
...
# ================================================================
# CELL 43 - V19 PRECISION RECALL CURVE
# ================================================================
...
plt.plot(
    ...
    label=f"V19 PR-AUC = {test_pr_auc:.4f}"
...
# ================================================================
# CELL 44 - V19 CONFUSION MATRIX PLOT
# ================================================================
...
# ================================================================
# CELL 52 - V19 EXPERIMENT SUMMARY
# ================================================================
...
# ================================================================
# CELL 54 - SAVE FINAL V19 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("SAVING FINAL V19 MODEL")
print("=" * 70)
...
# ================================================================
# ================================================================
# CELL 55 - V14 VS V16 VS V17 VS V18 VS V19
# ================================================================

print("\n")
print("=" * 70)
print("V14 VS V16 VS V17 VS V18 VS V19")
print("=" * 70)
...
# ------------------------------------------------
# V19 results from the current experiment
# ------------------------------------------------
v19_metrics = {
...
comparison_df["V19 - V18"] = (
    comparison_df["V19"] - comparison_df["V18"]
)

comparison_df["V19 - V17"] = (
    comparison_df["V19"] - comparison_df["V17"]
)

comparison_df["V19 - V16"] = (
    comparison_df["V19"] - comparison_df["V16"]
)

comparison_df["V19 - V14"] = (
    comparison_df["V19"] - comparison_df["V14"]
)
...
# CELL 56 - FINAL V19 SUMMARY
# ================================================================

print("\n")
print("=" * 70)
print("V19 EXPERIMENT COMPLETE")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V19 FINISHED SUCCESSFULLY")
print("=" * 70)
