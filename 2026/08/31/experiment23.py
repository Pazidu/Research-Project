...
print("=" * 70)
print("V23 MELANOMA CLASSIFICATION")
print("=" * 70)
...
# ================================================================
# CELL 5 - V23 DATASET CONFIGURATION
# ================================================================

print("\n" + "=" * 70)
print("V23 DATASET CONFIGURATION")
print("=" * 70)
...
MELANOMA_WEIGHT = 2.00

# V23 focal-loss focusing parameter
FOCAL_GAMMA = 1.0
...
# ================================================================
# CELL 14 - V23 DATA AUGMENTATION
# ================================================================

print("\n" + "=" * 70)
print("CREATING V23 DATA AUGMENTATION")
print("=" * 70)
...
data_augmentation = tf.keras.Sequential(
    ...
    [
        ...
        # ------------------------------------------------
        # V23 controlled augmentation (unchanged from V20)
        # ------------------------------------------------
    ...
    name="v23_augmentation"
)


print(
    "V23 augmentation created."
)
...
# ================================================================
# CELL 15 - V23 WEIGHTED FOCAL LOSS
# ================================================================
...
class MelanomaWeightedFocalLoss(
    ...
    def call(
        ...
        # difficult examples. gamma=1 is the controlled V23 focal-loss
...
# ================================================================
# CELL 17 - CREATE V23 MODEL
# ================================================================

print("\n" + "=" * 70)
print("CREATING V23 MODEL")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V23 STAGE 1 - FROZEN EFFICIENTNETV2-S")
print("=" * 70)
...
print("\n" + "=" * 70)
print("LOADING BEST V23 STAGE 1 MODEL")
print("=" * 70)
...
print("\n" + "=" * 70)
print("PREPARING V23 FINE-TUNING")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V23 STAGE 2 - FINE-TUNING EFFICIENTNETV2-S")
print("=" * 70)
...
# ================================================================
# CELL 27 - LOAD ABSOLUTE BEST V23 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("LOADING ABSOLUTE BEST V23 MODEL")
print("=" * 70)
...
print(
    "Absolute best V23 model loaded."
)
...
# ================================================================
# CELL 29 - V23 VALIDATION PREDICTIONS
# ================================================================

print("\n")
print("=" * 70)
print("V23 VALIDATION PREDICTIONS")
print("=" * 70)
...
# ================================================================
# CELL 30 - V23 VALIDATION PERFORMANCE
# ================================================================

print("\n" + "=" * 70)
print("V23 VALIDATION PERFORMANCE")
print("=" * 70)
...
# ================================================================
# CELL 32 - V23 VALIDATION THRESHOLD SEARCH
# ================================================================

print("\n")
print("=" * 70)
print("V23 VALIDATION THRESHOLD SEARCH")
print("=" * 70)
...
# ================================================================
# CELL 33 - V23 SENSITIVITY-CONSTRAINED SEARCH
# ================================================================

print("\n")
print("=" * 70)
print("V23 SENSITIVITY-CONSTRAINED THRESHOLD SEARCH")
print("=" * 70)
...
# ================================================================
# CELL 34 - SELECT FINAL V23 THRESHOLD
# ================================================================

print("\n")
print("=" * 70)
print("SELECTING V23 FINAL THRESHOLD")
print("=" * 70)
...
# ================================================================
# CELL 35 - V23 TEST PREDICTIONS
# ================================================================

print("\n")
print("=" * 70)
print("V23 TEST PREDICTIONS")
print("=" * 70)
...
# ================================================================
# CELL 36 - V23 TEST ROC / PR
# ================================================================

print("\n")
print("=" * 70)
print("V23 TEST ROC / PR")
print("=" * 70)
...
# ================================================================
# CELL 37 - FINAL V23 TEST RESULTS
# ================================================================
...
# ================================================================
# CELL 39 - V23 CLASSIFICATION REPORT
# ================================================================

print("\n")
print("=" * 70)
print("V23 CLASSIFICATION REPORT")
print("=" * 70)
...
# ================================================================
# CELL 40 - V23 TEST THRESHOLD COMPARISON
# ================================================================

print("\n")
print("=" * 70)
print("V23 TEST THRESHOLD COMPARISON")
print("=" * 70)
...
# ================================================================
# CELL 41 - V23 PROBABILITY ANALYSIS
# ================================================================

print("\n")
print("=" * 70)
print("V23 PROBABILITY ANALYSIS")
print("=" * 70)
...
plt.plot(
    ...
    label=f"V23 ROC-AUC = {test_roc_auc:.4f}"
...
# ================================================================
# CELL 43 - V23 PRECISION RECALL CURVE
# ================================================================
...
plt.plot(
    ...
    label=f"V23 PR-AUC = {test_pr_auc:.4f}"
...
# ================================================================
# CELL 44 - V23 CONFUSION MATRIX PLOT
# ================================================================
...
# ================================================================
# CELL 52 - V23 EXPERIMENT SUMMARY
# ================================================================
...
# ================================================================
# CELL 54 - SAVE FINAL V23 MODEL
# ================================================================

print("\n")
print("=" * 70)
print("SAVING FINAL V23 MODEL")
print("=" * 70)
...
# ================================================================
# ================================================================
# CELL 55 - V14 VS V16 VS V17 VS V18 VS V23
# ================================================================

print("\n")
print("=" * 70)
print("V14 VS V16 VS V17 VS V18 VS V23")
print("=" * 70)
...
# ------------------------------------------------
# V23 results from the current experiment
# ------------------------------------------------
v23_metrics = {
...
comparison_df["V23 - V20"] = comparison_df["V23"] - comparison_df["V20"]
comparison_df["V23 - V19"] = comparison_df["V23"] - comparison_df["V19"]
comparison_df["V23 - V18"] = comparison_df["V23"] - comparison_df["V18"]
comparison_df["V23 - V17"] = comparison_df["V23"] - comparison_df["V17"]
comparison_df["V23 - V16"] = comparison_df["V23"] - comparison_df["V16"]
comparison_df["V23 - V14"] = comparison_df["V23"] - comparison_df["V14"]
print(
...
# CELL 56 - FINAL V23 SUMMARY
# ================================================================

print("\n")
print("=" * 70)
print("V23 EXPERIMENT COMPLETE")
print("=" * 70)
...
print("\n")
print("=" * 70)
print("V23 FINISHED SUCCESSFULLY")
print("=" * 70)
